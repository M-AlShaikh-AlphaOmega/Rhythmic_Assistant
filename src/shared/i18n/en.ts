...
export const en = {
  ...
  'result.summaryTitle': 'Session settings',
  ...
  'result.streakTitle': '4-day streak — keep it up!',
  'result.streakSubtitle': 'Yesterday · 9 min · Gentle pace',
  'result.mood.goodCaption': 'Felt comfortable',
  'result.mood.sameCaption': 'No change noticed',
  'result.mood.hardCaption': 'Needed more effort',
  'result.walkStatsTitle': 'Walk stats',
  'result.steps': 'Steps',
  'result.cadence': 'Cadence',
  'result.distance': 'Distance',
  'result.cadenceUnit': '/min',
  'result.distanceUnit': 'km',
  'result.viewProgress': 'View your progress',

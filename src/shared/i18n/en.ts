...
export const en = {
  ...
  'running.activity': 'Walking',
  'running.inSync': 'In sync',
  'running.bpm': 'BPM',
  'running.elapsedLabel': 'ELAPSED',
  'running.elapsedOf': 'of',
  'running.elapsedDone': 'done',
  'running.timeLeft': 'left',
  'running.cueAudio': 'Audio cue',
  'running.cueVibration': 'Vibration cue',
  'running.cueCombined': 'Audio + buzz',
  'running.cueHint': 'tap your steps',
  'running.steps': 'Steps',
  'running.cadence': 'Cadence',
  'running.cadenceUnit': '/min',
